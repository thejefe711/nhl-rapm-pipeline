...
const METRIC_CATEGORIES = [
    ...
    {
        id: 'situational',
        title: 'Situational Metrics',
        description: 'Context-aware metrics measuring performance against specific levels of competition or role dependence.',
        metrics: [
            {
                name: 'Shutdown Rank',
                key: 'shutdown_score_z',
                description: 'Defensive suppression specifically when matched against Elite opponents (top 20% by Off Corsi).',
                interpretation: 'High positive values (Z-score) identify true shutdown defenders who excel when facing the hardest matchups.',
                goodRange: '> +1.0σ',
                eliteRange: '> +2.0σ',
            },
            {
                name: 'Breaker Rank',
                key: 'breaker_score_z',
                description: 'Offensive expected goals generation specifically when matched against Elite defensive opponents.',
                interpretation: 'High positive values identify forwards who can "break" strong defensive structures and generate offense against top shutdown pairs.',
                goodRange: '> +1.0σ',
                eliteRange: '> +2.0σ',
            },
            {
                name: 'Clutch Shutdown',
                key: 'clutch_shutdown_z',
                description: 'Defensive suppression in close games (score differential <= 1).',
                interpretation: 'High positive values indicate players who elevate their defensive play in clutch situations.',
                goodRange: '> +1.0σ',
                eliteRange: '> +2.0σ',
            },
            {
                name: 'Clutch Breaker',
                key: 'clutch_breaker_z',
                description: 'Offensive expected goals generation in close games (score differential <= 1).',
                interpretation: 'High positive values identify players who can generate offense when the game is on the line.',
                goodRange: '> +1.0σ',
                eliteRange: '> +2.0σ',
            },
            {
                name: 'Growth Elasticity',
                key: 'elasticity_z',
                description: 'Measures how a player\'s per-60 performance changes as their total ice time increases over the season.',
                interpretation: 'Positive elasticity indicates a player who handles larger workloads well and could thrive with more ice time.',
                goodRange: '> +1.0σ',
                eliteRange: '> +2.0σ',
            },
            {
                name: 'Partner Sensitivity (PSI)',
                key: 'psi_z',
                description: 'Measures how much a player\'s performance depends on the quality of their linemates.',
                interpretation: 'Lower values represent independence (driving play themselves). Higher values represent dependence (passengers).',
                goodRange: '< -1.0σ',
                eliteRange: '< -2.0σ',
            },
            {
                name: 'Two-way PSI',
                key: 'psi_twoway_z',
                description: 'Measures how much a player\'s overall (two-way) performance depends on the quality of their linemates.',
                interpretation: 'Lower values indicate two-way independence. Higher values indicate dependence on linemates for both offensive and defensive success.',
                goodRange: '< -1.0σ',
                eliteRange: '< -2.0σ',
            },
        ],
    ...
    {
        id: 'linemates',
        title: 'Linemate Metrics',
        description: 'Analysis of player combinations and defensive pair synergies.',
        metrics: [
            {
                name: 'Chemistry Delta',
                key: 'xga_delta_per60',
                description: 'The difference between a pair\'s actual xGA/60 and their expected xGA/60 based on league averages.',
                interpretation: 'Negative values indicate strong chemistry (allowing fewer chances than expected). Positive values indicate poor fit.',
                goodRange: '< -0.10',
                eliteRange: '< -0.30',
            },
        ],
